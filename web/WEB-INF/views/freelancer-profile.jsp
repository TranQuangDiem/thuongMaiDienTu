...
<head>
	...
	<body>
                ...
                <div class="row bottom-mrg">
                    <div class="col-md-12 col-sm-12">
                        <div class="advance-detail detail-desc-caption">
                            <h4>Nguyễn Văn A</h4><span class="designation">Design Logo</span>
                            <ul>
        ...
        <section class="full-detail-description full-detail gray-bg">
								...
								<div id="post-job" class="tab-pane fade">
									...
									<div class="row">
										<article>
											<div class="mng-company">
												<div class="col-md-2 col-sm-2">
													<div class="mng-company-pic"><img src="${pageContext.request.contextPath}/resources/assets/img/com-1.jpg" class="img-responsive" alt=""></div>
												</div>
										...
										<article>
											<div class="mng-company">
												<div class="col-md-2 col-sm-2">
													<div class="mng-company-pic"><img src="${pageContext.request.contextPath}/resources/assets/img/com-2.jpg" class="img-responsive" alt=""></div>
												</div>
										...
										<article>
											<div class="mng-company">
												<div class="col-md-2 col-sm-2">
													<div class="mng-company-pic"><img src="${pageContext.request.contextPath}/resources/assets/img/com-3.jpg" class="img-responsive" alt=""></div>
												</div>
										...
										<article>
											<div class="mng-company">
												<div class="col-md-2 col-sm-2">
													<div class="mng-company-pic"><img src="${pageContext.request.contextPath}/resources/assets/img/com-4.jpg" class="img-responsive" alt=""></div>
												</div>
										...
										<article>
											<div class="mng-company">
												<div class="col-md-2 col-sm-2">
													<div class="mng-company-pic"><img src="${pageContext.request.contextPath}/resources/assets/img/com-5.jpg" class="img-responsive" alt=""></div>
												</div>
										...
										<article>
											<div class="mng-company">
												<div class="col-md-2 col-sm-2">
													<div class="mng-company-pic"><img src="${pageContext.request.contextPath}/resources/assets/img/com-6.jpg" class="img-responsive" alt=""></div>
												</div>
										...
										<article>
											<div class="mng-company">
												<div class="col-md-2 col-sm-2">
													<div class="mng-company-pic"><img src="${pageContext.request.contextPath}/resources/assets/img/com-7.jpg" class="img-responsive" alt=""></div>
												</div>
									...
									<div class="inbox-body inbox-widget">
											...
											<div class="col-sm-12">
												<div class="well well-sm">
													<div class="text-right">
														<a class="btn btn-primary btn-rate" href="#reviews-anchor" id="open-review-box">Đánh giá</a>
													</div>
															...
															<form accept-charset="UTF-8" action="" method="post">
																...
																<div class="text-right">
																	<div class='rating-stars'>
																		<ul id='stars'>
																		  <li class='star' title='Rất Tệ' data-value='1'>
																			<i class='fa fa-star fa-fw'></i>
																		  </li>
																		  <li class='star' title='Tệ' data-value='2'>
																			<i class='fa fa-star fa-fw'></i>
																		  </li>
																		  <li class='star' title='Bình Thường' data-value='3'>
																			<i class='fa fa-star fa-fw'></i>
																		  </li>
																		  <li class='star' title='Tốt' data-value='4'>
																			<i class='fa fa-star fa-fw'></i>
																		  </li>
																		  <li class='star' title='Rất Tốt' data-value='5'>
																			<i class='fa fa-star fa-fw'></i>
																		  </li>
																		</ul>
																	  </div>
																	<a class="btn btn-danger btn-rate-cancel" href="#" id="close-review-box" style="margin-right: 10px;">Cancel</a>
										...
										<div class="mail-card">
											<header class="card-header cursor-pointer collapsed" data-toggle="collapse" data-target="#meaages-2" aria-expanded="false">
												<div class="card-title flexbox">
												  <img class="img-responsive img-circle avatar" src="${pageContext.request.contextPath}/resources/assets/img/can-2.png" alt="...">
												  <div>
													<h6>Daniel Duke</h6>
										...
										<div class="mail-card">
											<header class="card-header cursor-pointer collapsed" data-toggle="collapse" data-target="#meaages-4" aria-expanded="false">
												<div class="card-title flexbox">
												  <img class="img-responsive img-circle avatar" src="${pageContext.request.contextPath}/resources/assets/img/can-3.png" alt="...">
												  <div>
													<h6>Daniel Duke</h6>
													<small>Today at 07:34 AM</small>
												  </div>
										...
										<div class="mail-card">
											<header class="card-header cursor-pointer collapsed" data-toggle="collapse" data-target="meaages-5" aria-expanded="false">
												<div class="card-title flexbox">
												  <img class="img-responsive img-circle avatar" src="${pageContext.request.contextPath}/resources/assets/img/can-4.png" alt="...">
												  <div>
													<h6>Daniel Duke</h6>
													<small>Today at 07:34 AM</small>
												  </div>
			...
			<script src="${pageContext.request.contextPath}/resources/assets/js/vietnamlocalselector.js"></script>
