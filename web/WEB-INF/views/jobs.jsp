					...
					<div class="wrapper">
						...
						<section class="inner-header-title no-br advance-header-title"
							...
							<div class="container">
								...
								<p>
									Hiện tại chúng tôi đang có <span>
										<c:out value="${numberJobIsOpen}"></c:out> Công Việc
						...
						<section class="bottom-search-form">
							<div class="container">
								<form id="form-category" class="bt-form" action='<c:url value="/jobs"></c:url>'>
									<div class="col-md-3 col-sm-6">
										...
										<c:if test="${jobtitle ne '' }">
											<input type="text" class="form-control" value="${jobtitle }" name="jobtitle"
												placeholder="Tên Công Việc">
										</c:if>

									</div>
									<div hidden="true" class="col-md-4 col-sm-6">
										<label>Quận / Huyện</label> <select name="address.district" class="form-control"
											id="huyen"></select>

									</div>
									<div hidden="true" class="col-md-4 col-sm-6">
										<label>Xã Phường</label> <select name="address.ward" class="form-control"
											id="xa"></select>
									</div>
									<div class="col-md-3 col-sm-6">
									...
									<div class="sidebar right-sidebar">
										...
										<div class="side-widget">
											...
											<div class="widget-text padd-0">
												<div class="ad-banner">
													<img src="http://via.placeholder.com/320x285" class="img-responsive"
														alt="">
												</div>
											</div>
										</div>
										...
										<div class="side-widget">
											...
											<div class="widget-text padd-0">
												<ul>
													<li><span class="custom-checkbox"> <input type="checkbox" id="1">
															<label for="1"></label>
														</span> Under $10,000 <span class="pull-right">102</span></li>
													<li><span class="custom-checkbox"> <input type="checkbox" id="2">
															<label for="2"></label>
														</span> $10,000 - $15,000 <span class="pull-right">78</span>
													</li>
													<li><span class="custom-checkbox"> <input type="checkbox" id="3">
															<label for="3"></label>
														</span> $15,000 - $20,000 <span class="pull-right">12</span>
													</li>
													<li><span class="custom-checkbox"> <input type="checkbox" id="4">
															<label for="4"></label>
														</span> $20,000 - $30,000 <span class="pull-right">85</span>
													</li>
													<li><span class="custom-checkbox"> <input type="checkbox" id="5">
															<label for="5"></label>
										...
										<div class="side-widget">
											...
											<div class="widget-text padd-0 collapse" id="job-location">
												<ul>
													...
													<li><span class="custom-checkbox"> <input type="checkbox" id="6">
															<label for="6"></label>
														...
														<div class="col-md-6 col-sm-6">
															...
															<div class="advance-search-caption">
																<a href="${pageContext.request.contextPath}/job-apply-detail?id_job=${job.id}" title="Job Dtail">
																	...
																	<c:out value="${job.ofAccount.name }"></c:out>
																</span>
															</div>
														</div>
														<div class="col-md-4 col-sm-4">
											...
											<ul class="pagination">
												...
												<c:forEach var="i" begin="${startPageIndex}" end="${endPageIndex}">
													<c:if test="${i==pageIndex }">
														<li class="active"><a href="<c:url value="
																...
																</c:url>"><c:out value="${i}"></c:out></a></li>
													</c:if>
													<c:if test="${i!=pageIndex }">
														<li><a href="<c:url value="
																jobs?page=${i}&${jobtitlehref}${provincehref}${majorhref}${sortbyhref}${sortorderhref}">
												...
												<c:if test="${endPageIndex<totalPage}">
													<li><a href="<c:url value="
															...
															</c:url>"><i class="fa fa-ellipsis-h"></i></a></li>
												</c:if>
