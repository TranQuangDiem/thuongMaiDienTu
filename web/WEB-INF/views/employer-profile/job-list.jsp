...
<div id="post-job" class="tab-pane fade" >
	<h3>You have ${EmployerProfileDatabase.countJob} job post</h3>
	<div class="row" >
					...
					<div class="mng-company">
						...
						<div class="col-md-5 col-sm-5">
							<div class="mng-company-name">
								<h4>
									${job.jobTitle} <span class="cmp-tagline">(Software
										Company)</span>
								</h4>
						...
						<div class="col-md-1 col-sm-1">
							<div class="mng-company-action">
								<a href="${pageContext.request.contextPath}/job-apply-detail?id_job=${job.id}"><i class="fa fa-edit"></i></a><a href="#"><i
