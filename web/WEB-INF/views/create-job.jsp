<%@ page language="java" pageEncoding="UTF-8" %>
	...
	================================================== -->
								...
								<!-- Custom style -->
								<link href="${pageContext.request.contextPath}/resources/assets/css/style.css"
									rel="stylesheet">
								<link href="${pageContext.request.contextPath}/resources/assets/css/style1.css"
									rel="stylesheet">
							...
							<body>
								...
								<div class="wrapper">
									...
									<div class="clearfix"></div>
									<!-- Header Title End -->
									<form:form enctype="multipart/form-data" modelAttribute="formcreatejob"
										id="form-createjob" action="${pageContext.request.contextPath}/createjob">
											...
											<div class="container white-shadow">
												<div class="row">
													<div class="detail-pic js">
														<div class="box">
															<input type="file" name="img" id="upload-pic"
																class="inputfile" />
														...
														<div class="col-md-6 col-sm-6">
															<div class="input-group">
																<select name="major" class="form-control input-lg">
																	<option value="" disabled selected hidden>Kĩ năng
																		yêu
																		cầu</option>
																	<c:forEach var="major" items="${listMajors}">
																		<option
																			value='<c:out value="${major.id}"></c:out>'>
														...
														<div class="col-md-12 col-sm-12">
															<div class="input-group">
																<input type="text" name="finishday" id="company-dob"
																	...
																	data-min-year="2020" data-max-year="2021"
															...
															success: function (
																...
																switch (res) {
																	...
																	case 'empty':
																		...
																		break;
																	case 'fail':
																		showResult(true, "Hệ thống xảy ra lỗi");
																		break;
																	case 'money':
																		showResult(true, 'Hãy nạp thêm tiền để đăng bài');
																		break;
																	case 'ok':
																		showResult(false, 'Đăng bài thành công');
																		window.location.href = "${pageContext.request.contextPath}/create-job";
																		break;
																	default:
																		showResult(true, 'Có lỗi xảy ra hoặc bạn đã để trống các trường bắt buộc');
																		break;
																}
															}
														});
