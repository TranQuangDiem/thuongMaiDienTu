    ...
    <div class="sidebar-header">
        <img src="assets/images/logo.svg" alt="" srcset="">
     	...
     	<div class="sidebar-menu">
				...
				</div>    <button class="sidebar-toggler btn x"><i data-feather="x"></i></button>
</div>
        </div>
        <div id="main">
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        ...
        <a href="<c:url value="/pricing-add"/>" class="btn-green" style="float: right;">
        ...
        <div class="table-responsive">
          <table class="table table-hover mb-0">
            ...
            <tbody>
              ...
              <c:if test="${not empty listpricing }">
              ...
              <td class="text-bold">${pricing.id}</td>
                ...
                <td class="text-bold">
                    <a href="<c:url value="/pricing-detail"/>?id=${pricing.id}" class="btn green mr0 btn-search-text-single btnSearchMore">
                        <i class="fa fa-wrench"></i>
                    </a>
                </td>
                <td class="text-bold">
                    <a href="<c:url value="/Pricing-delete"/>?id=${pricing.id}" class="btn green mr0 btn-search-text-single btnSearchMore">
