    ...
    <div class="card">
      ...
      <div class="cardcontent">
        ...
        <div class="table-responsive">
            <div class="form">
                <form action="<c:url value="addpricing"/>" method=post modelAttribute="Pricing">
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <label for="formGroupExampleInput">Tên gói bài đăng</label><span style="color:red" id="error1"></span>
                          <input type="text" id="tengoi" name="tengoi" class="form-control" placeholder="Tên gói bài đăng">
                        </div>

                        <div class="col-md-6 col-12">
                            <label for="formGroupExampleInput2">Giá(vnđ)</label><span style="color:red" id="error2"></span>
                          <input type="number" id="gia" name="gia" class="form-control" placeholder="Giá(vnđ)">
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-6 col-12">
                            <label for="formGroupExampleInput">Số lượng bài đăng(bài)</label><span style="color:red" id="error3"></span>
                          <input type="number" id="soluongbaidang" name="soluongbaidang" class="form-control" placeholder="Số lượng bài đăng(bài)">
                        </div>

                        <div class="col-md-6 col-12">
                            <label for="formGroupExampleInput">Thời gian(ngày)</label><span style="color:red" id="error4"></span>
                          <input type="number" id="thoihan" name="thoihan" class="form-control" placeholder="Thời gian(ngày)">
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-6 col-12">
                            <label for="formGroupExampleInput">Mô tả</label><span style="color:red" id="error5"></span>
                          <textarea type="text" id="mota" name="mota" class="form-control" placeholder="Mô tả"></textarea>
                        </div>
                    

                      </div>
                      <div class="col-12 d-flex justify-content-end">
                                        <input class="btn btn-primary mr-1 mb-1" onclick="return kiemtra();" type="submit" value="Save">
...
<!-- Hoverable rows end -->
    ...
    var flag;
    function ten(){
    	var tengoi=document.getElementById("tengoi").value.trim();
    	if(tengoi.length<1){
    		
    		document.getElementById('error1').innerHTML="tên gói không được để trống"
    		flag=false;
    	}else{
    ...
    function gia(){
        	...
        	if(gia.length<1){
        		document.getElementById('error2').innerHTML="giá không được để trống"
        		flag=false;
        	}else if(gia<0){
        		document.getElementById('error2').innerHTML="giá nhập sai"
        			flag=false;
        	}else{
        		document.getElementById('error2').innerHTML="";
        	}
    	}
    	function soluongbaidang(){
    		
        	var soluongbaidang=document.getElementById("soluongbaidang").value.trim();
    		if(soluongbaidang.length<1){
        		document.getElementById('error3').innerHTML=" không được để trống"
        			flag=false;
        	}else if(soluongbaidang<0){
        		document.getElementById('error3').innerHTML="thời hạn nhập sai";
        			flag=false;
        	}else{
    	...
    	function thoihan(){
        	...
        	var thoihan=document.getElementById("thoihan").value.trim();
    		if(thoihan.length<1){
        		document.getElementById('error4').innerHTML="thời hạn không được để trống";
        		flag=false;
        	}else if(thoihan<0){
        		document.getElementById('error4').innerHTML="thời hạn nhập sai"
        			flag=false;
        	}else{
    	...
    	function mota(){
    		...
    		if(mota.length<1){
        		document.getElementById('error5').innerHTML="mô tả không được để trống";
        		flag=false
        	}else{
