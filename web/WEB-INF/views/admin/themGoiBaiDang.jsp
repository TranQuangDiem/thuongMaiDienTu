    ...
    <div class="card">
      ...
      <div class="cardcontent">
        ...
        <div class="table-responsive">
            <div class="form">
                <form action="<c:url value="/pricing-add"/>" method="post" modelAttribute="Pricing">
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <label for="formGroupExampleInput">Tên gói bài đăng</label><span id="error1" style="color:red"></span>
                          <input type="text" class="form-control" required autofocus id="tengoi" name="tengoi" placeholder="Tên gói bài đăng">
                        </div>

                        <div class="col-md-6 col-12">
                            <label for="formGroupExampleInput2">Giá(đ)</label><span id="error2" style="color:red"></span>
                          <input type="number" class="form-control" required id="gia" name="gia" placeholder="Giá">
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-6 col-12">
                            <label for="formGroupExampleInput">Số lượng bài đăng(bài)</label><span id="error3" style="color:red"></span><span id="error1" style="color:red"></span>
                          <input type="number" class="form-control" required id="soluongbaidang" name="soluongbaidang" placeholder="Số lượng bài đăng">
                        </div>

                        <div class="col-md-6 col-12">
                            <label for="formGroupExampleInput">Thời gian(ngày)</label><span id="error4" style="color:red"></span>
                          <input type="number" class="form-control" required id="thoihan" name="thoihan" placeholder="Thời gian">
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-6 col-12">
                          ...
                          <textarea type="text" class="form-control" required id="mota" name="mota" placeholder="Mô tả"></textarea>
                        </div>
