							...
							<div class="sidebar-wrapper active">
								...
								<div class="sidebar-menu">
									<ul class="menu">
										...
										<li class="sidebar-item  has-sub active"><a href="#" class='sidebar-link'> <i
										...
										<li class="sidebar-item "><a href='<c:url value="admin-list-major"></c:url>'
												...
												<div class="card-body">
													<form class="form">
														<div class="row">
															...
															<div class="col-md-4 col-12">
																<div class="form-group">
																	<label for="first-name-column">Số lượng
																		tuyển</label> <input type="text"
																		id="first-name-column" class="form-control"
																		placeholder="<c:out value="
																		${job.soluongtuyen}"></c:out>"
															...
															<div class="col-md-4 col-12">
																<div class="form-group">
																	...
																	<input type="text" id="first-name-column"
																		...
																		${dateHelper.parseToString(job.createday)}">
																	</c:out>"
															...
															<div class="col-md-4 col-12">
																<div class="form-group">
																	...
																	<input type="text" id="first-name-column"
																		class="form-control" placeholder="<c:out value="
																		${dateHelper.parseToString(job.finishday)}">
																	</c:out>"
														...
														name="info-column" disabled></textarea>
															...
															<div class="col-md-6 col-12">
																<div class="form-group">
																	<label for="first-name-column">Ảnh</label> <img
																		class="img-fluid" alt=""
																		src="data:image/jpge;base64,<c:out value="
																		${job.img}"></c:out>">
																</div>
															</div>
															<div class="col-md-4 col-12">
																<div class="form-group">
																	...
																	<input type="text" id="first-name-column"
																		class="form-control" placeholder="<c:out value="
																		${job.ofAccount.name}"></c:out>"
																	name="diaChi-column" disabled="trending-up">
																</div>
															</div>
															<div class="col-md-4 col-12">
																<div class="form-group">
																	<label for="first-name-column">Loại công
																		việc</label> <input type="text"
																		id="first-name-column" class="form-control"
																		placeholder="<c:out value="
																		${jobModel.toStringOfJobType(job.jobType)}">
																	</c:out>"
																	name="diaChi-column" disabled="trending-up">
																</div>
															</div>
															<div class="col-md-4 col-12">
																<div class="form-group">
																	<label for="first-name-column">Trạng thái</label>
																	<input type="text" id="first-name-column"
																		class="form-control" placeholder="<c:out value="
																		${jobModel.toStringOfStatus(job.status)}">
																	</c:out>"
																	name="diaChi-column" disabled="trending-up">
																</div>
															</div>
															...
															<div class="col-12 d-flex justify-content-end">
																<div class="form-group checkbox-1 mr-3 mt-3">
																	<label for="first-name-column">Ẩn</label> <label
																		class="checkbox-2" name="block-column">
																		<c:choose>
																			<c:when test="${job.status==3}">
																				<input checked name="isHide"
																					type="checkbox">
																			</c:when>
																			<c:otherwise>
																				<input name="isHide" type="checkbox">
																			</c:otherwise>
																		</c:choose> <span class="background"></span>
