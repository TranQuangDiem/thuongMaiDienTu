$(document).ready(function () {
    ...
    $('#checkbox-active-job').change(function (e) { 
        ...
        if(checkboxHire.val()!='true'){
            ...
            $('#span-hire').text("Đang tuyển dụng");
    ...
    $('#checkbox-active-freelancer').change(function (e) { 
      ...
      if(checkboxHire.val()!='true'){
          ...
          $('#span-hire-freelancer').css('color', "#7f8c8d");
          $('#span-hire-freelancer').text("Không sẵn sàng");
      }else{
          $('#p-hireable-freelancer').css('color', "#2ecc71");
          $('#p-hireable-freelancer').text("Sẵn sàng");
          $('#span-hire-freelancer').css('color', "#2ecc71");
          $('#span-hire-freelancer').text("Sẵn sàng");
      }
  });
...
$(function(){
  ...
  {
    e.preventDefault();
    openReviewBtn.fadeIn(500);
    reviewBox.slideUp(500, function()
      {
        newReview.focus();
        // closeReviewBtn.hide();
      });
